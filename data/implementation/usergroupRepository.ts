...
export default class usergroupRepository implements iusergroupRepository
{
            ...
            return usergroup.find()
                       .then(businesses => {
                        let usergroup_Model= Array<usergroupModel>();
                            ...
                            re.groupid = element.groupid;re.groupname=element.groupname;
    ...
    public getUserGroupById(pkId:string):any
    {
        try {
            ...
            .then((v:any)=>{
                ...
                user.groupid = v.groupid;user.groupname=v.groupname;user.groupdescription=v.groupdescription;
                console.log(user);
                return user;
            }).catch(err => {
                console.error(err)
    ...
    public saveUserGroup(usergroup:usergroupModel):void
    {
        try {
            ...
            let usergroup_ = new user_group({groupid:usergroup.groupid,groupname : usergroup.groupname,groupdescription:usergroup.groupdescription});
    ...
    public updateUserGroup(usergroup:usergroupModel,id:string):any
    {
        try {
          ...
          {
              data.groupid=usergroup.groupid;data.groupname= usergroup.groupname;data.cogroupdescriptionde=usergroup.groupdescription;
              console.log(data)
